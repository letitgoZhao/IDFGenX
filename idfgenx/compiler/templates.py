...
def _base_templates(spec: ResolvedScenarioSpec) -> dict[str, Any]:
    ...
    return {
        ...
        "Material": {
            ...
            "Generic Internal Material": {"roughness": "MediumSmooth", "thickness": 0.2, "conductivity": 0.8, "density": 1800.0, "specific_heat": 900.0},
        },
        ...
        "Construction": {
            ...
            "Internal Construction": {"outside_layer": "Generic Internal Material"},
